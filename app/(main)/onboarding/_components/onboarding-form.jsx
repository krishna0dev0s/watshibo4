          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6" suppressHydrationWarning>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                {...register("experience")}
                className="bg-black/20 border-white/10 backdrop-blur-sm focus:border-white/20 focus:ring-white/20 transition-colors"
              />
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                className="h-32 bg-black/20 border-white/10 backdrop-blur-sm focus:border-white/20 focus:ring-white/20 transition-colors"
                {...register("bio")}
              />
            ...
            <Button 
              type="submit" 
              className="w-full bg-white/10 hover:bg-white/15 text-white border border-white/10 hover:border-white/20 backdrop-blur-sm transition-all" 
