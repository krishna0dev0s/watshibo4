      ...
      <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="hero-title">
              ...
              <div className="mt-8">
                <Link href="/ai-cover-letter/new">
                  <Button className="bg-white/20 hover:bg-white/30 backdrop-blur-sm border-white/20 transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-lg hover:shadow-white/10 group">
        ...
        <div className="max-w-6xl mx-auto space-y-12">
          ...
          <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Quick Stats Cards */}
            <div className="bg-card/30 border border-white/10 backdrop-blur-sm rounded-xl p-6 flex items-center space-x-4">
