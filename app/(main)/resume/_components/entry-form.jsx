    ...
    <div className="space-y-4">
      <div className="space-y-4">
        {entries.map((item, index) => (
          <Card key={index} className="bg-background/40 border border-white/10 backdrop-blur-sm transition-all duration-300 hover:bg-background/60 hover:shadow-lg hover:shadow-white/5">
        ...
        <Card className="bg-background/40 border border-white/10 backdrop-blur-sm">
          ...
          <CardFooter className="flex justify-end space-x-2">
            ...
            <Button 
              type="button" 
              onClick={handleAdd}
              className="bg-white/20 hover:bg-white/30 backdrop-blur-sm border-white/20 transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-lg hover:shadow-white/10"
            >
      ...
      {!isAdding && (
        <Button
          className="w-full bg-white/20 hover:bg-white/30 backdrop-blur-sm border-white/20 transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-lg hover:shadow-white/10 group"
