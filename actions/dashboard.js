...
export const generateAIInsights = async (industry) => {
  try {
    ...
    const prompt = `
          You are a professional industry analyst. Analyze the current state of the ${industry} industry in 2025 and provide insights in the following JSON format.
          
          Requirements:
          1. ONLY return valid JSON, no other text
          2. Include EXACTLY 5 roles in salaryRanges with accurate salary data
          3. Growth rate must be a realistic percentage for ${industry}
          4. Include EXACTLY 5 items in topSkills, keyTrends, and recommendedSkills
          5. All data must be specific to ${industry} and current as of 2025
          6. Salary ranges must reflect current market rates
          7. Location should be specific to major tech hubs
